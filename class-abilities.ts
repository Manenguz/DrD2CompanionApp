...
const classAbilitiesData: Record<string, Ability[]> = {
  ...
  "Lovec": [
    ...
    },
    {
      ...
      description: "Postava je zběhlá (některé manévry zdarma) v hledání cesty, potravy a přístřeší v divočině, v lovu zvířat, rybolovu, zpracování kořisti a plavbě. (bez aktivace, Duše)"
    },
    {
      name: "Stopař",
